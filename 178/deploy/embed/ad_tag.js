							...
							function RepublicProjectApp() {
							    ...
							    var RepublicProjectAppInstance = {
							        ...
							        createFrontImage: function() {
							            ...
							            img.src = "http://dev.republicproject.com/user/178/deploy/userassets/iau.jpg";
							            img.width = 300;
							            img.height = 250;
							    ...
							    this.unit_image.attachEvent("on" + "click", function() {
							        ...
							        loadIframe: function() {
							            ...
							            iframe.src = "http://dev.republicproject.com/mobile/app.html?id=178&unit=3&click_macro="+root.click_macro+"&cache_buster="+root.cache_buster;
